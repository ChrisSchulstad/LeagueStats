...
var mainRef = new Firebase("https://leaguestats.firebaseio.com/");
...
app.controller('LoginController', ["$scope", '$state', function($scope, $state){
  ...
  mainRef.onAuth(function(authData){
    ...
    var ref = new Firebase("https://leaguestats.firebaseio.com/users");
...
function authFB(){
  ...
  var ref = new Firebase("https://leaguestats.firebaseio.com/");
